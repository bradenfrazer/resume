  ...
  return (
    <ul className="md:grid grid-cols-2">
      <li className="mt-1.5 flex items-start text-md text-gray-700 leading-normal md:order-1">
        <span className="icon-parent flex items-center flex-shrink-0">
          <svg
      ...
      <li className="mt-1.5 flex items-start text-md text-gray-700 leading-normal md:order-2">
        ...
        >
          <span className="icon-parent inline-flex items-center flex-shrink-0">
            <svg
              className="w-4.5 h-4.5"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
              <path
                className="text-gray-600 group-hover:text-gray-700 change-color-fast print:text-gray-900 fill-current"
